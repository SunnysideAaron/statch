...
Inspect config: map[outputFile:./models2.go sources:[map[sourceFile:./schema.sql type:schema] map[sourceFile:queries.sql type:queries]] templateFile:./models.plush]
Template File: ./models2.go</li>
